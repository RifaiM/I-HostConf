...
<body class="bg-secondary">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg bg-light mt-2 rounded pb-3">
                <h2 class="text-primary p-2">Search Data Orders</h2>
				...
				<div id="menu">
                    <ul>
                        ...
                        <li><a href="/Conference/login_register/exportData/ExportCustomerData/index.php">Export data Customers</a></li>
                ...
                <div class="form-inline pl-3">
                    ...
                    <input type="text" name="search" id="search_text" class="form-control form-control-md rounded-2 border-secondary" placeholder="type here.." style="font-family: Calibri;">
                </div>
                <?php
                    include '../config.php';
                    $stmt = $conn->prepare("SELECT * FROM orders ORDER BY id ASC");
                    $stmt->execute();
